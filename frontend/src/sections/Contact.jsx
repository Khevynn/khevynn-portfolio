    ...
    >
      <div className="mb-10 sm:mb-16">
        ...
        <p className="text-sm sm:text-base lg:text-lg text-zinc-400 mt-4 max-w-xl font-inter leading-relaxed">
          I am actively looking for new opportunities as a <strong className="text-zinc-200">Junior Java / Backend Developer</strong>. Whether it's a question, a collaboration, or just a hello, my inbox is always open.
        </p>
      </div>
